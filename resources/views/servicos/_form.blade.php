            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('nome', $servico->nome ?? '') }}" type="input" class="form-control"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('posicao', $servico->posicao ?? '')  }}" type="input" class="form-control"
                            name="posicao" id="posicao" data-mask="00" placeholder="Posição do serviço na plataforma">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_minimo', $servico->valor_minimo ?? '')  }}" type="input"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('quantidade_horas', $servico->quantidade_horas ?? '')  }}" type="input"
                            class="form-control" name="quantidade_horas" id="quantidade_horas" data-mask="0"
